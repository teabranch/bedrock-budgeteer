...
- **Feature flag gating** — `enable_agentcore_budgeting`, `enable_key_provisioning`, and `enable_cost_allocation_reporting` in `budgeteer.config.yaml` control whether their respective constructs and runtime support are enabled.
